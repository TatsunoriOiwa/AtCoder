...
public class Main {
	...
	public void run(PrintWriter out) {
		...
		Pos[] poss = new Pos[N];
		for (int i = 0; i < N; i++) {
			poss[i] = new Pos(sc.nextLong(), sc.nextLong());
		}
	...
	private boolean test(Pos pos0, Pos pos1, Pos pos2) {
		long dx1 = pos1.x - pos0.x;
		long dy1 = pos1.y - pos0.y;
		long dx2 = pos2.x - pos0.x;
		long dy2 = pos2.y - pos0.y;
